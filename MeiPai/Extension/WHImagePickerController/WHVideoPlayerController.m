...
@interface WHVideoPlayerController () {
    AVPlayer *_player;
...
@implementation WHVideoPlayerController
...
- (void)configMoviePlayer {
    [[WHImageManager manager] getPhotoWithAsset:_model.asset completion:^(UIImage *photo, NSDictionary *info) {
        _cover = photo;
    }];
    [[WHImageManager manager] getVideoWithAsset:_model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
