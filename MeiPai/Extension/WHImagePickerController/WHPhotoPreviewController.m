...
@interface WHPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@implementation WHPhotoPreviewController
...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[WHPhotoPreviewCell class] forCellWithReuseIdentifier:@"WHPhotoPreviewCell"];
}

#pragma mark - Click Event

- (void)select:(UIButton *)selectButton {
    WHAssetModel *model = _photoArr[_currentIndex];
    ...
    [self refreshNaviBarAndBottomBarState];
    if (model.isSelected) {
        [UIView showOscillatoryAnimationWithLayer:selectButton.imageView.layer type:WHOscillatoryAnimationToBigger];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    WHPhotoPreviewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"WHPhotoPreviewCell" forIndexPath:indexPath];
...
- (void)showPhotoBytes {
    [[WHImageManager manager] getPhotosBytesWithArray:@[_photoArr[_currentIndex]] completion:^(NSString *totalBytes) {
